...
import 'package:dhahar_lib_restaurant/features/coupon/widgets/coupon_delete_bottom_sheet.dart';
import 'package:dhahar_lib_restaurant/features/language/controllers/localization_controller.dart';
import 'package:dhahar_lib_restaurant/features/coupon/screens/add_coupon_screen.dart';
import 'package:dhahar_lib_restaurant/features/coupon/widgets/coupon_card_dialogue_widget.dart';
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text('on ${Get.find<ProfileController>().profileModel!.restaurants?[0].name ?? ''}', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor)),
                                        ...
                                        children: [
                                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                            ...
                                            Container(
                                              width: 40,
                                              decoration: BoxDecoration(
                                                color: status ? Theme.of(context).primaryColor : Theme.of(context).hintColor,
