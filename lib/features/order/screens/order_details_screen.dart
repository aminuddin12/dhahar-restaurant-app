...
import 'package:dhahar_lib_restaurant/common/widgets/confirmation_dialog_widget.dart';
import 'package:dhahar_lib_restaurant/common/widgets/custom_app_bar_widget.dart';
import 'package:dhahar_lib_restaurant/common/widgets/custom_asset_image_widget.dart';
import 'package:dhahar_lib_restaurant/common/widgets/custom_bottom_sheet_widget.dart';
import 'package:dhahar_lib_restaurant/common/widgets/custom_button_widget.dart';
import 'package:dhahar_lib_restaurant/common/widgets/custom_image_widget.dart';
import 'package:dhahar_lib_restaurant/common/widgets/custom_snackbar_widget.dart';
import 'package:dhahar_lib_restaurant/common/widgets/custom_text_field_widget.dart';
import 'package:dhahar_lib_restaurant/common/widgets/details_custom_card.dart';
import 'package:dhahar_lib_restaurant/common/widgets/input_dialog_widget.dart';
...
import 'package:dhahar_lib_restaurant/features/order/widgets/edit_order/edit_history_log_bottom_sheet.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/edit_order/order_edit_confirmation_bottom_sheet.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/pdf_generate_dialog.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/section_widget.dart';
...
import 'package:dhahar_lib_restaurant/features/order/domain/models/order_details_model.dart';
import 'package:dhahar_lib_restaurant/features/order/domain/models/order_model.dart';
import 'package:dhahar_lib_restaurant/features/order/screens/invoice_print_screen.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/available_deliveryman_bottom_sheet_widget.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/camera_button_sheet_widget.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/cancellation_dialogue_widget.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/collect_money_delivery_sheet_widget.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/dialogue_image_widget.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/order_product_widget.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/slider_button_widget.dart';
import 'package:dhahar_lib_restaurant/features/order/widgets/verify_delivery_sheet_widget.dart';
import 'package:dhahar_lib_restaurant/helper/date_converter_helper.dart';
import 'package:dhahar_lib_restaurant/helper/price_converter_helper.dart';
import 'package:dhahar_lib_restaurant/helper/responsive_helper.dart';
import 'package:dhahar_lib_restaurant/helper/route_helper.dart';
import 'package:dhahar_lib_restaurant/util/dimensions.dart';
import 'package:dhahar_lib_restaurant/util/images.dart';
import 'package:dhahar_lib_restaurant/util/styles.dart';
            ...
            appBar: CustomAppBarWidget(
              ...
              menuWidget: Row(
                children: [
                  ...
                  Get.find<ProfileController>().profileModel!.restaurants![0].canEditOrder! && (controllerOrderModel?.orderStatus == 'pending'
                  ...
                  SizedBox(width: Get.find<ProfileController>().profileModel!.restaurants![0].canEditOrder! ? 10 : 0),
            ...
            body: (orderController.orderDetailsModel != null && controllerOrderModel != null && restaurant != null) ? Column(children: [
              ...
              SafeArea(
                child: Container(
                  ...
                  ) : showSlider ? ((controllerOrderModel.orderStatus == 'pending') && ((controllerOrderModel.orderType == 'take_away' || restConfModel || selfDelivery) || controllerOrderModel.orderType == 'dine_in') && cancelPermission!) ? Row(children: [
