...
ThemeData light = ThemeData(
  fontFamily: 'Roboto',
  primaryColor: const Color(0xffff6831),
  secondaryHeaderColor: const Color(0xffff904c),
  ...
  TextButton.styleFrom(foregroundColor: const Color(0xffff6831))),
  colorScheme: const ColorScheme.light(primary: Color(0xffff6831),
      secondary: Color(0xffff904c)).copyWith(
